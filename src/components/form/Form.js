  ...
  return (
    <form onSubmit={sendEmail}>
      <div>
        ...
        <input name="nr" type="text" placeholder={`Nr. ${formData.number}`} />
      </div>
      <div>
        <label>Dit navn og efternavn:</label>
        <input name="name" type="text" placeholder="Anders Andersen" />
      </div>
      <div>
        <label>Dit telefon nr.:</label>
        <input name="number" type="number" placeholder="+45 12 34 56 78" />
      </div>
      <div>
